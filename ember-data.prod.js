(function() {
    ...
    */
    ...
    var ember$inflector$lib$lib$system$inflector$$default;

    function initEmberInflectorBindingIfNecessary() {
      if (ember$inflector$lib$lib$system$inflector$$default === undefined) {
        ember$inflector$lib$lib$system$inflector$$default = require('ember-inflector').default;
      }
    }

    function ember$inflector$lib$lib$system$string$$pluralize(word) {
      initEmberInflectorBindingIfNecessary();
